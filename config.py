...
class Development(Config):
    ...
    BOT_TOKEN = "7572603594:AAEE5WKw34dyxnX4eq6VRyIzznmpACkdFVE"  # Create a bot from @BotFather and paste the token here
    ...
    LOGGER_ID = -1002093247039  # Fill Your Group logger id -100
